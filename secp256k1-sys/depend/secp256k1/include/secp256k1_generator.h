 ...
 *  comparison, use rustsecp256k1_v0_2_0_generator_serialize and rustsecp256k1_v0_2_0_generator_parse.
 */
typedef struct {
    unsigned char data[64];
} rustsecp256k1_v0_2_0_generator;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_generator_parse(
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_generator_serialize(
    const rustsecp256k1_v0_2_0_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_generator_generate(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_generator* gen,
 ...
 *
 *  The result is equivalent to first calling rustsecp256k1_v0_2_0_generator_generate,
 *  converting the result to a public key, calling rustsecp256k1_v0_2_0_ec_pubkey_tweak_add,
 *  and then converting back to generator form.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_generator_generate_blinded(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_generator* gen,
