...
} rustsecp256k1_v0_2_0_musig_pre_session;
...
typedef struct {
    ...
    rustsecp256k1_v0_2_0_xonly_pubkey nonce;
    int partial_nonce_parity;
    unsigned char nonce_commitments_hash[32];
    rustsecp256k1_v0_2_0_xonly_pubkey combined_nonce;
    int combined_nonce_parity;
} rustsecp256k1_v0_2_0_musig_session;
...
} rustsecp256k1_v0_2_0_musig_session_signer_data;
...
} rustsecp256k1_v0_2_0_musig_partial_signature;
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_pubkey_combine(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_scratch_space *scratch,
    rustsecp256k1_v0_2_0_xonly_pubkey *combined_pk,
    rustsecp256k1_v0_2_0_musig_pre_session *pre_session,
    const rustsecp256k1_v0_2_0_xonly_pubkey *pubkeys,
    size_t n_pubkeys
 ...
 *  passes `rustsecp256k1_v0_2_0_xonly_pubkey_tweak_test`.
 *
 ...
 *  it, you can just use `rustsecp256k1_v0_2_0_xonly_pubkey_tweak_add`. Can only be called
 ...
 *                       according to rustsecp256k1_v0_2_0_ec_seckey_verify, this function
 *                       returns 0. For uniformly random 32-byte arrays the
 *                       chance of being invalid is negligible (around 1 in
 *                       2^128) (cannot be NULL).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_musig_pubkey_tweak_add(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_pre_session *pre_session,
    rustsecp256k1_v0_2_0_pubkey *output_pubkey,
    const rustsecp256k1_v0_2_0_xonly_pubkey *internal_pubkey,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_session_init(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_session *session,
    rustsecp256k1_v0_2_0_musig_session_signer_data *signers,
    unsigned char *nonce_commitment32,
    const unsigned char *session_id32,
    const unsigned char *msg32,
    const rustsecp256k1_v0_2_0_xonly_pubkey *combined_pk,
    const rustsecp256k1_v0_2_0_musig_pre_session *pre_session,
    size_t n_signers,
    size_t my_index,
 ...
 *  `rustsecp256k1_v0_2_0_musig_session_init` and after all nonce commitments have
 *  been collected
 *
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_musig_session_get_public_nonce(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_session *session,
    rustsecp256k1_v0_2_0_musig_session_signer_data *signers,
 ...
 *                    2^32 - 1.
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_session_init_verifier(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_session *session,
    rustsecp256k1_v0_2_0_musig_session_signer_data *signers,
    const unsigned char *msg32,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_musig_set_nonce(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_session_signer_data *signer,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_session_combine_nonces(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_session *session,
    const rustsecp256k1_v0_2_0_musig_session_signer_data *signers,
    size_t n_signers,
    int *nonce_parity,
    const rustsecp256k1_v0_2_0_pubkey *adaptor
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_partial_signature_serialize(
    const rustsecp256k1_v0_2_0_context* ctx,
    unsigned char *out32,
    const rustsecp256k1_v0_2_0_musig_partial_signature* sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_partial_signature_parse(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_partial_signature* sig,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_partial_sign(
    const rustsecp256k1_v0_2_0_context* ctx,
    const rustsecp256k1_v0_2_0_musig_session *session,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_musig_partial_sig_verify(
    const rustsecp256k1_v0_2_0_context* ctx,
    const rustsecp256k1_v0_2_0_musig_session *session,
    const rustsecp256k1_v0_2_0_musig_session_signer_data *signer,
    const rustsecp256k1_v0_2_0_musig_partial_signature *partial_sig,
    const rustsecp256k1_v0_2_0_xonly_pubkey *pubkey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_musig_partial_sig_combine(
    const rustsecp256k1_v0_2_0_context* ctx,
    const rustsecp256k1_v0_2_0_musig_session *session,
    unsigned char *sig64,
    const rustsecp256k1_v0_2_0_musig_partial_signature *partial_sigs,
    size_t n_sigs
 ...
 */
SECP256K1_API int rustsecp256k1_v0_2_0_musig_partial_sig_adapt(
    const rustsecp256k1_v0_2_0_context* ctx,
    rustsecp256k1_v0_2_0_musig_partial_signature *adaptor_sig,
    const rustsecp256k1_v0_2_0_musig_partial_signature *partial_sig,
 ...
 *   nonce_parity: the `nonce_parity` output of `musig_session_combine_nonces`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_musig_extract_secret_adaptor(
    const rustsecp256k1_v0_2_0_context* ctx,
