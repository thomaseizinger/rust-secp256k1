 ...
 *  comparison, use rustsecp256k1_v0_2_0_pedersen_commitment_serialize and
 *  rustsecp256k1_v0_2_0_pedersen_commitment_parse.
 */
typedef struct {
    unsigned char data[64];
} rustsecp256k1_v0_2_0_pedersen_commitment;

/**
 * Static constant generator 'h' maintained for historical reasons.
 */
SECP256K1_API extern const rustsecp256k1_v0_2_0_generator *rustsecp256k1_v0_2_0_generator_h;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_pedersen_commitment_parse(
 ...
 *  In:     commit:     a pointer to a rustsecp256k1_v0_2_0_pedersen_commitment containing an
 *                      initialized commitment
 */
SECP256K1_API int rustsecp256k1_v0_2_0_pedersen_commitment_serialize(
    const rustsecp256k1_v0_2_0_context* ctx,
    unsigned char *output,
    const rustsecp256k1_v0_2_0_pedersen_commitment* commit
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_pedersen_commit(
  const rustsecp256k1_v0_2_0_context* ctx,
  rustsecp256k1_v0_2_0_pedersen_commitment *commit,
  const unsigned char *blind,
  uint64_t value,
  const rustsecp256k1_v0_2_0_generator *gen
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_pedersen_blind_sum(
  const rustsecp256k1_v0_2_0_context* ctx,
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_pedersen_verify_tally(
  const rustsecp256k1_v0_2_0_context* ctx,
  const rustsecp256k1_v0_2_0_pedersen_commitment * const* commits,
  size_t pcnt,
  const rustsecp256k1_v0_2_0_pedersen_commitment * const* ncommits,
  size_t ncnt
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_pedersen_blind_generator_blind_sum(
  const rustsecp256k1_v0_2_0_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_rangeproof_verify(
  const rustsecp256k1_v0_2_0_context* ctx,
  uint64_t *min_value,
  uint64_t *max_value,
  const rustsecp256k1_v0_2_0_pedersen_commitment *commit,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_rangeproof_rewind(
  const rustsecp256k1_v0_2_0_context* ctx,
  unsigned char *blind_out,
  uint64_t *value_out,
 ...
 *
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_rangeproof_sign(
  const rustsecp256k1_v0_2_0_context* ctx,
  unsigned char *proof,
  size_t *plen,
  uint64_t min_value,
 ...
 *        max_value: pointer to an unsigned int64 which will be updated with the maximum value that commit could have. (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_2_0_rangeproof_info(
  const rustsecp256k1_v0_2_0_context* ctx,
  int *exp,
  int *mantissa,
  uint64_t *min_value,
