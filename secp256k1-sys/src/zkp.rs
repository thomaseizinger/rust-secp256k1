...
extern "C" {
    #[cfg_attr(
        ...
        link_name = "rustsecp256k1_v0_2_0_pedersen_commitment_parse"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_pedersen_commitment_serialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_pedersen_commit"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_pedersen_blind_generator_blind_sum"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_surjectionproof_initialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_surjectionproof_serialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_surjectionproof_serialized_size"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_surjectionproof_parse"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_surjectionproof_generate"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_surjectionproof_verify"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_generator_generate_blinded"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_generator_serialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1_v0_2_0_generator_parse"
    )]
