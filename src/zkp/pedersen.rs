...
impl<C: Signing> Secp256k1<C> {
    /// Commit to a value with a certain blinding factor and generator.
    pub fn commit(
        &self,
        value: u64,
...
impl<C: Signing> Secp256k1<C> {
    ...
    pub fn compute_adaptive_blinding_factor(
        &self,
        value: u64,
        generator_blinding_factor: SecretKey,
    ...
    #[must_use]
    pub fn verify_commitments_sum_to_equal(
        &self,
        ...
        let ret = unsafe {
            ffi::secp256k1_pedersen_verify_tally(self.ctx, a.as_ptr(), a.len(), b.as_ptr(), b.len())
        };
...
mod tests {
    ...
    fn test_equal_sum_of_commitments() {
        ...
        let commitment_4 = SECP256K1.commit(1000, vbf_4, blinded_tag_4);

        let commitment_sums_are_equal = SECP256K1.verify_commitments_sum_to_equal(
